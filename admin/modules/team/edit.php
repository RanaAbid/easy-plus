...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    <h3 class="mb-sm-0 mb-1 fs-18">Edit Team Member</h3>
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Edit Team Member</span>
        </li>
    </ul>
</div>
...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            <h4 class="fw-semibold fs-18 mb-sm-0">Edit Team Member</h4>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        ...
                        <input id="txt_name" name="txt_name" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter name" value="<?= htmlspecialchars($member['name']) ?>" required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        <label for="txt_position" class="label">Position *</label>
                        <input id="txt_position" name="txt_position" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter position" value="<?= htmlspecialchars($member['position']) ?>" required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        <label for="txt_email" class="label">Email</label>
                        <input id="txt_email" name="txt_email" type="email" class="form-control text-dark ps-5 h-58" placeholder="Enter email" value="<?= htmlspecialchars($member['email']) ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        <label for="txt_phone" class="label">Phone</label>
                        <input id="txt_phone" name="txt_phone" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter phone" value="<?= htmlspecialchars($member['phone']) ?>">
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group mb-4">
                        <label for="txt_bio" class="label">Bio</label>
                        <textarea id="txt_bio" name="txt_bio" class="form-control ps-5 text-dark" rows="4" placeholder="Enter bio"><?= htmlspecialchars($member['bio']) ?></textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        ...
                        <div class="mb-2" id="current_image_container">
                            <?php $imgUrl = str_replace('/admin/', '/', $app_path) . 'assets/img/team/' . htmlspecialchars($member['image']); ?>
                        ...
                        <div class="form-control h-100 text-center position-relative p-4 p-lg-5" style="min-height: 200px;">
                            <div class="product-upload">
                                <label for="txt_image" class="file-upload mb-0" style="cursor: pointer;">
                                    ...
                                    <span class="d-block fw-semibold text-body"><?= $member['image'] ? 'Change image' : 'Drop files here or click to upload.' ?></span>
                                </label>
                ...
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        ...
                        <input id="txt_facebook_url" name="txt_facebook_url" type="url" class="form-control text-dark ps-5 h-58" placeholder="https://facebook.com/..." value="<?= htmlspecialchars($member['facebook_url']) ?>">
                    </div>
                    <div class="form-group mb-4">
                        <label for="txt_twitter_url" class="label">Twitter URL</label>
                        <input id="txt_twitter_url" name="txt_twitter_url" type="url" class="form-control text-dark ps-5 h-58" placeholder="https://twitter.com/..." value="<?= htmlspecialchars($member['twitter_url']) ?>">
                    </div>
                    <div class="form-group mb-4">
                        <label for="txt_linkedin_url" class="label">LinkedIn URL</label>
                        <input id="txt_linkedin_url" name="txt_linkedin_url" type="url" class="form-control text-dark ps-5 h-58" placeholder="https://linkedin.com/..." value="<?= htmlspecialchars($member['linkedin_url']) ?>">
                    </div>
                    <div class="form-group mb-4">
                        <label for="txt_instagram_url" class="label">Instagram URL</label>
                        <input id="txt_instagram_url" name="txt_instagram_url" type="url" class="form-control text-dark ps-5 h-58" placeholder="https://instagram.com/..." value="<?= htmlspecialchars($member['instagram_url']) ?>">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        <label for="txt_sort_order" class="label">Sort Order</label>
                        <input id="txt_sort_order" name="txt_sort_order" type="number" class="form-control text-dark ps-5 h-58" value="<?= $member['sort_order'] ?>" min="0">
