...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    <h3 class="mb-sm-0 mb-1 fs-18">Add Testimonial</h3>
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Add Testimonial</span>
        </li>
    </ul>
</div>
...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            <h4 class="fw-semibold fs-18 mb-sm-0">Add Testimonial</h4>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        ...
                        <input id="txt_client_name" name="txt_client_name" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter client name" required>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        <label for="txt_client_position" class="label">Position</label>
                        <input id="txt_client_position" name="txt_client_position" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter position">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                        <label for="txt_client_company" class="label">Company</label>
                        <input id="txt_client_company" name="txt_client_company" type="text" class="form-control text-dark ps-5 h-58" placeholder="Enter company name">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
                ...
                <div class="col-lg-12">
                    <div class="form-group mb-4">
                        ...
                        <textarea id="txt_testimonial" name="txt_testimonial" class="form-control ps-5 text-dark" rows="5" placeholder="Enter testimonial text" required></textarea>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group mb-4">
