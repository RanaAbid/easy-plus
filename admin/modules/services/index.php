...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
    ...
    if ($_POST['action'] == 'toggle_status' && $id > 0) {
        $query = "SELECT status FROM services WHERE id = ?";
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            $_SESSION['alert_message'] = 'Service status changed to ' . ucfirst($new_status) . ' successfully!';
            $_SESSION['alert_status'] = $new_status;
        } else {
            $_SESSION['alert_type'] = 'error';
            $_SESSION['alert_message'] = 'Error changing service status';
        }
        mysqli_stmt_close($stmt);
...
if (isset($_GET['success'])) {
    $_SESSION['alert_type'] = 'success';
    $_SESSION['alert_message'] = 'Service saved successfully!';
}
if (isset($_GET['error'])) {
    $_SESSION['alert_type'] = 'error';
...
$services = [];
$query = "SELECT * FROM services ORDER BY sort_order ASC, id DESC";
...
<div class="d-sm-flex text-center justify-content-between align-items-center mb-4">
    <h3 class="mb-sm-0 mb-1 fs-18">Services Module</h3>
    <ul class="ps-0 mb-0 list-unstyled d-flex justify-content-center">
        ...
        <li>
            <span class="fw-semibold fs-14 heading-font text-dark dot ms-2">Services Module</span>
        </li>
    </ul>
</div>
...
<div class="card bg-white border-0 rounded-10 mb-4">
    <div class="card-body p-4">
        <div class="d-sm-flex text-center justify-content-between align-items-center border-bottom pb-20 mb-20">
            <h4 class="fw-semibold fs-18 mb-sm-0">Manage Services</h4>
            ...
            <div class="table-responsive">
                <table class="table align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="6" class="text-center">No services found. <a href="create.php">Add your first service</a></td>
                        </tr>
                        <?php else: ?>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <div class="d-flex gap-2 justify-content-center">
                                    <span class="bg-<?= $service['status'] == 'active' ? 'success' : 'danger' ?> bg-opacity-10 text-<?= $service['status'] == 'active' ? 'success' : 'danger' ?> fs-13 fw-semibold py-1 px-2 rounded-1">
                                ...
                                <div class="d-flex gap-2 justify-content-center">
                                    <form method="post" action="index.php" style="display: inline;" class="status-toggle-form">
                                        ...
                                        <button type="submit" 
                                                ...
                                                data-item-name="this service">
                                            <i data-feather="<?= $service['status'] == 'active' ? 'check-circle' : 'x-circle' ?>"></i>
                                        </button>
                                    </form>
                                    <a href="edit.php?id=<?= $service['id'] ?>" class="btn btn-sm btn-primary" title="Edit">
