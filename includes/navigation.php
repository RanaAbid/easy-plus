    ...
    <div class="container">
        <div class="menu-top">
            <div class="row justify-content-between align-items-center gx-sm-0">
                <div class="col">
                    <div class="header-logo"><a href="<?= $app_path ?>"><img src="<?= $app_path ?>assets/img/easyplus/logo.png" alt="Easy-Plus" class="logo" style="width: 30%;"></a></div>
                </div>
                ...
                <div class="col-auto header-info d-none d-xl-flex">
                    ...
                    <div class="media-body"><span class="header-info_label">Office Address</span>
                        <div class="header-info_link">United Arab Emirates</div>
                    </div>
                </div>
            </div>
        </div>
